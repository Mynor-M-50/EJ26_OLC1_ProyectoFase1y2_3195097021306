...
public class NodoMultiplicacion extends NodoAST {
    public NodoAST izquierda;
    public NodoAST derecha;

    public NodoMultiplicacion(NodoAST izquierda, NodoAST derecha, int linea, int columna) {
        super(linea, columna);
    ...
    public Object interpretar() {
        ...
        throw new RuntimeException("Operación invaqlida en multiplicacion, linea " + linea);
    }
}